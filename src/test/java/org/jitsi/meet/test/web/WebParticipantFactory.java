...
public class WebParticipantFactory
    ...
    private WebDriver startWebDriver(
        ...
        if (participantType.isFirefox()) {
            ...
            System.out.println(fakeStreamVideoFile);
...
//            }
            ...
            if (isRemote) {
                ops.addArguments(Arrays.asList("disable-infobars", "ignore-certificate-errors", "start-maximized","use-fake-ui-for-media-stream"));
                ops.setCapability(CapabilityType.BROWSER_NAME, "chrome");
                ops.setCapability(CapabilityType.VERSION, "80.0");
